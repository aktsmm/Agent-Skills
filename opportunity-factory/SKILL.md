...
- For user-facing artifacts, carry design and actual-render acceptance through the producing lanes, not only the workflow reviewer; generated screenshots or passing builds are not visual acceptance (`references/workflow.md` -> `Rendered-UI Acceptance`).
