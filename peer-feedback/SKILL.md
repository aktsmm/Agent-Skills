...
- **コアバリュー・ミッション接続**: 行動や成果を会社のコアバリュー（Growth Mindset, Customer Obsessed, Diverse & Inclusive, One Microsoft）やミッション（Empower every person and every organization on the planet to achieve more）と紐付けて言語化する。押し付けがましくならない程度に自然に織り込む
