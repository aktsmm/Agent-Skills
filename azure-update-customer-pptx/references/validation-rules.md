...
28. Export customer PDFs from a unique local OpenXML copy and verify its SHA-256 before and after export. If OneDrive or organizational protection re-wraps the canonical PPTX as OLE, content verification uses the hash-matched retained OpenXML source; missing or invalid retained OpenXML fails rather than opening the protected file as ZIP.
