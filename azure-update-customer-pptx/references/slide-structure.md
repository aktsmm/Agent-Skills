...
Within Weekly New Topics, order slides: 1) **【廃止】** 2) **【GA】** 3) **【Preview】**
4) **【アナウンス】/【更新】**. Priority reads as: needs-action → now-usable → future → notice/other.
...
```json
{
  "weekly": [
    {
      ...
      "basics": ["既定の送信アクセス: VM が明示的な送信設定なしで…", "NAT Gateway: …", "暗黙的 vs 明示的: …"],
  ...
  "appendix": [
    { "title": "…", "basics": ["…"], "userValue": "…", "technical": "…",
      "beforeAfter": "…", "systemImpact": "…", "excludeReason": "Weekly 不要（運用影響少）" }
  ]
}
```
