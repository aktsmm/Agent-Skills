...
- `scripts/esxp_client.py`: CDP WebSocket client + module-level retry helpers (`urlopen_retry` / `ws_connect_retry`). New ESXP scripts MUST import these from here (WinError 10048 hardening); do not reimplement.
